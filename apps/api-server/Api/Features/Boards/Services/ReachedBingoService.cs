...
public static class ReachedBingoService
{
    ...
    {
        return ReachedStrikeInDiagonal(cells) || ReachedStrikeInRow(cells) || ReachedStrikeInColumn(cells);
    }

    public static bool ReachedStrikeInColumn(BoardCellGET[] cells)
    {
        return ReachedPattern(cells, colPatterns);
    }

    public static bool ReachedStrikeInRow(BoardCellGET[] cells)
    {
        return ReachedPattern(cells, rowPatterns);
    }

    public static bool ReachedStrikeInDiagonal(BoardCellGET[] cells)
    {
